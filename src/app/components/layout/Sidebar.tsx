...
import {
  ...
  Users, BarChart3, Lightbulb, Bot, Zap, Settings, Building2, ShoppingBag, Percent, RotateCcw, Landmark
} from "lucide-react";
...
const menuItems = [
  ...
  { path: "/specialties", label: "특산품 관리", icon: ShoppingBag },
  { path: "/fees-taxes", label: "수수료·세금", icon: Percent },
